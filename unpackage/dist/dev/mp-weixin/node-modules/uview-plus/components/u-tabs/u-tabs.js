...
const _sfc_main = {
  ...
  computed: {
    textStyle() {
      return (index) => {
        const style = {};
        const customeStyle = index === this.innerCurrent ? common_vendor.addStyle(this.activeStyle) : common_vendor.index.$u.addStyle(
          this.inactiveStyle
        );
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0546c3e4"], ["__file", "D:/aProject/qingliao-fe/node_modules/uview-plus/components/u-tabs/u-tabs.vue"]]);
