...
const _sfc_main = {
  name: "u--text",
  mixins: [common_vendor.mpMixin, common_vendor.mixin, common_vendor.value, common_vendor.button, common_vendor.openType, common_vendor.props],
  emits: ["click"],
  computed: {
    valueStyle() {
      const style = {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-5fec1d8b"], ["__file", "D:/aProject/qingliao-fe/node_modules/uview-plus/components/u-text/u-text.vue"]]);
